...
const botname = process.env.BOTNAME || 'DEATH STROKE';
const antibot = process.env.ANTIBOT || 'FALSE';
    ...
    const packname = process.env.STICKER_PACKNAME || 'DEATH STROKE';
...
case "getvar": 
 ...
 break;
        ...
        case "gpt": case "gpt": 
            ...
            if (!text) return reply("Hello am 𝗗𝗘𝗔𝗧𝗛-𝗦𝗧𝗥𝗢𝗞𝗘 an Ai developed by 𝗬𝗢𝗕𝗕𝗬, how can I help you today?");
...
async function handleGPTMessage(text, m) {
  if (!text) return m.reply("Hello am 𝗗𝗘𝗔𝗧𝗛-𝗦𝗧𝗥𝗢𝗞𝗘 an Ai developed by 𝗬𝗢𝗕𝗕𝗬, how can I help you today?");
